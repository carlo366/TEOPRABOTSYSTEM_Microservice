...
@section('title','Admin | All kondisi')
@push('css')
...
<!--Form Add kondisi  -->
<div class="modal fade text-left" id="tambahkondisi" tabindex="-1" role="dialog"
aria-labelledby="myModalLabel33" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content">
        <div class="modal-header">

            <h4 class="modal-title" id="myModalLabel33">Tambah kondisi</h4>

                    </div>
                    <form action="{{ route('storekondisi') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <label>Nama kondisi</label>
                            <div class="form-group">
                                <input type="text" name="name" placeholder="Nama kondisi" class="form-control" required oninput="this.value = this.value.charAt(0).toUpperCase() + this.value.slice(1);" autofocus>
                            </div>
...
<div class="main-content container-fluid">
    <div class="page-title">
        ...
        <div class="pb-3 pt-4"><button type="button" class="btn btn-success p-3"  data-bs-toggle="modal" data-bs-target="#tambahkondisi"> Tambah kondisi</button></div>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$category['name']}}</td>                            <td>
                                <a href="{{route('editkondisi', $category['ID'])}}" class="btn btn-warning">Edit</a>
...
function confirmDelete(productId) {
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                window.location.href = "{{ route('deletekondisi', ':id') }}".replace(':id', productId);
