                    ...
                    <form action="{{ route('storekategori') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <input type="text" name="name" placeholder="Nama Kategori" class="form-control" required oninput="this.value = this.value.charAt(0).toUpperCase() + this.value.slice(1);" autofocus>
                            </div>
                ...
                <table class='table table-striped' id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>{{$category['name']}}</td>
                            <td><img src="{{ asset('uploads/category/' . $category['image']) }}" alt="" style="height: 2em"></td>
                            <td>
